          ...
          <div className=" flex gap-40">
              ...
              <div className={'flex gap-6  w-3/6 justify-end px-10'}>
                  {summaryInfo?.summary_details?.session_score && (<div className={'flex flex-col items-center'}>
                      <div class="w-32 h-32 rounded-full bg-lightBlue flex items-center justify-center">
                  ...
                  {summaryInfo?.summary_details?.overall_sentiment && (<div className={'flex flex-col items-center'}>
                      <div class="w-32 h-32 rounded-full bg-lightGreen flex items-center justify-center">
